...
export const CharacterCard = styled.div<{ $theme?: string }>`
...
export const CharacterTitle = styled.h2<{ $theme?: string }>`
  font-size: 20px;
  font-weight: 600;
  margin-bottom: 8px;
  color: ${({ $theme }) => ($theme === 'dark' ? '#f9fafb' : '#111827')};
...
export const CharacterContent = styled.p<{ $theme?: string }>`
  font-size: 14px;
