...
import listTimelinesForUser from '../listTimelinesForUser'
...
describe('listTimelinesForUser', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })

  it('should return timelines for a valid user', async () => {
    const mockClient = {
    ...
    const result = await listTimelinesForUser({
      userid: 'user-123',
      limit: '10',
      offset: '0',
    })
